...
class TestHevyClient:
    ...
    def test_init_with_env_token(
        ...
        """Test HevyClient initialization with various environment token values."""
    ...
    def test_api_methods(
        ...
        """Test API methods (get_workout and get_user_by_username)."""
...
class TestIntegration:
    ...
    def test_complete_request_flow(
        ...
        """Test complete flow from HevyClient to HTTP request."""
        # Setup mock response
        mock_response = Mock()
